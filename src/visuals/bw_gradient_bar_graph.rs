...
visual! {
    name            = "B/W Gradient Bar Graph";
    highlight_color = Color::RED;

    BwGradientBarGraph::new(self) {
        BwGradientBarGraph { 
        ...
        for i in 0 .. shared.array.len() {
            ...
            let color = {
                if let Some(color) = LineVisual::get_highlight_color(last_i, i, indices) {
                    ...
                    let color_value = (40.0 + value * self.color_const) as u8;
        ...
        for i in 0 .. shared.aux.len() {
            ...
            let color = {
                if let Some(color) = LineVisual::get_highlight_color(last_i, i, indices) {
                    ...
                    let color_value = (40.0 + value * self.aux_color_const) as u8;
                    Color::new(color_value, color_value, color_value, 255)
                }
            };
